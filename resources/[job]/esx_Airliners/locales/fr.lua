Locales['fr'] = {
  ...
  ['cloakroom_prompt'] = 'apppuyer ~INPUT_CONTEXT~ pour ouvrir le vestiaire.',
  ['wear_citizen'] = 'tenue civil',
  ['wear_work'] = 'tenue airline',

  -- garage
  ['spawner_prompt'] = 'appuyer ~INPUT_CONTEXT~ pour ouvrir garage.',
  ['store_veh'] = 'appuyez sur ~INPUT_CONTEXT~ pour ranger le véhicule.',
  ['spawn_veh'] = 'sortir véhicule',
  ['spawnpoint_blocked'] = 'un véhicule est bloqué au point!',
  ['only_taxi'] = 'vous ne pouvez ranger que les avions',
  ...
  ['start_job'] = 'start / stop courses moldu.',
