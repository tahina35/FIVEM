...
RegisterServerEvent('esx_bahamasjob:getFridgeStockItem')
AddEventHandler('esx_bahamasjob:getFridgeStockItem', function(itemName, count)
...
ESX.RegisterServerCallback('esx_bahamasjob:getFridgeStockItems', function(source, cb)
...
RegisterServerEvent('esx_bahamasjob:putFridgeStockItems')
AddEventHandler('esx_bahamasjob:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_bahamasjob:buyItem')
AddEventHandler('esx_bahamasjob:buyItem', function(itemName, price, itemLabel)
...
RegisterServerEvent('esx_bahamasjob:craftingCoktails')
AddEventHandler('esx_bahamasjob:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('esx_bahamasjob:getVaultWeapons', function(source, cb)
...
ESX.RegisterServerCallback('esx_bahamasjob:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_bahamasjob:removeVaultWeapon', function(source, cb, weaponName)
